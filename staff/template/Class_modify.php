...
<body>
    ...
    <section class="content">
        ...
        <h3>變更班級名稱</h3>
       	<form action="class_modify.php?id=<% id %>" method="post" class="form-horizontal">
        ...
        <a href="class_modify.php?id=<% id %>&method=delete" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>刪除班級</a>
    </section>
    </div>
</body>
</html>