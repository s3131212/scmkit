...
<body>
    ...
    <div class="container">
        ...
        <section class="content">
            ...
            <form action="modify_student.php?id=<% id %>" method="post">
            ...
            <h3>新增請假</h3>
                <form action="new_leave.php?id=<% id %>&method=leave" method="post">
                    <h4>事假</h4>
