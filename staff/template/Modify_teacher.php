...
<body>
    ...
    <section class="content">
        ...
        <a href="modify_teacher.php?id=<% id %>&method=delete" class="btn"><span class="glyphicon glyphicon-trash"></span>刪除教師</a>
        ...
        <a href="teacher_list.php" class="btn btn-default">回到列表</a>
    </section>
    </div>
</body>
</html>