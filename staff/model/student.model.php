...
class Student_Model {
    ...
    public function new_student($name,$id,$login_name,$academic_year,$password,$class_grade,$class_name,$address,$phone,$personalid){
        ...
        $GLOBALS['db']->insert(array("name"=>View::xss_filter($name),"id"=>View::xss_filter($id),"login_name"=>View::xss_filter($login_name),"academic_year"=>View::xss_filter($academic_year),"password"=>md5($password),"class"=>$class[0]["id"],"address"=>View::xss_filter($address),"phone"=>View::xss_filter($phone),"personalid"=>View::xss_filter($personalid),"incentive"=>'[{"firstleveldemerit":"0","secondleveldemerit":"0","warning":"0","firstcredit":"0","secondcredit":"0","reward":"0"}]'),"student");
