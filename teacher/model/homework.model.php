...
class Homework_Model {
    ...
    public function new_homework($name,$start_date,$end_date,$description,$class){
        $GLOBALS['db']->insert(array("name"=>View::xss_filter($name),"start_date"=>View::xss_filter($start_date),"end_date"=>View::xss_filter($end_date),"description"=>View::xss_filter($description,true),"class"=>$class),"homework");
    ...
    public function modify_homework($name,$start_date,$end_date,$description,$class,$id){
        $GLOBALS['db']->update("homework",array("name"=>View::xss_filter($name),"start_date"=>View::xss_filter($start_date),"end_date"=>View::xss_filter($end_date),"description"=>View::xss_filter($description,true),"class"=>$class),array("id"=>$id));
    }
