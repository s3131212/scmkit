...
<body>
    ...
    <section class="content">
        ...
        <div class="teacher_share">
            <% alert %>
            <a href="tshare-modify.php?id=<% id %>&method=delete" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>刪除檔案</a>
            <form class="form-horizontal" role="form" style="margin-top:30px;" method="post" action="tshare-modify.php?id=<% id %>">
