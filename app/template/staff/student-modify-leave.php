<html>
    ...
    $(document).ready(function(){
        ...
        $("#submit").on("click",function(){
            ...
            $(".loading").show();
            $.ajax({
                url: "ajax/student-modify-leave.php?mode=new",
                type: "POST",
                data: {
                    type: $("#type").val(),
                    lessons: $("#lessons").val(),
        ...
        $("#submit2").on("click",function(){
            ...
            $(".loading").show();
            $.ajax({
                url: "ajax/student-modify-leave.php?mode=modify",
                type: "POST",
                data: {
                    type: $("#type2").val(),
                    lessons: $("#lessons2").val(),
                    date: $("#date2").val(),
                    reason: $("#reason2").val(),
                    id: '<% id %>'
                },
...
<body>
    ...
    <section class="content">
        ...
        <div class="box" id="new_box">
        	...
        	<form>
        		<input type="text" class="form-control" id="type" name="type" placeholder="請假種類"><br />
        		<input type="text" class="form-control" id="lessons" name="lessons" placeholder="節數"><br />
        		<input type="text" class="form-control" id="date" name="date" placeholder="日期" value="<% date %>"><br />
        		<textarea name="reason" id="reason">請假原因</textarea><br />
        ...
        <div class="box" id="modify_box">
            ...
            <div class="alertcon" style="height:60px;"></div>
            <form>
                <input type="text" class="form-control" id="type2" name="type2" placeholder="請假種類" value="<% type %>"><br />
                <input type="text" class="form-control" id="lessons2" name="lessons2" placeholder="節數" value="<% lessons %>"><br />
                <input type="text" class="form-control" id="date2" name="date2" placeholder="日期" value="<% date %>"><br />
                <textarea name="reason2" id="reason2"><% reason %></textarea><br />
