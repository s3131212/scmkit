...
<body>
    ...
    <div class="container">
        ...
        <section class="content">
            ...
            <div class="box box-6">
                <a href="score-new.php" class="btn"><button>新增成績</button></a><a href="score_import.php" class="btn"><button>匯入成績</button></a>
                <table class="score">
            ...
            <div class="box box-6">
                <h3>成績單</h3>
                <a href="scoresheet-modify.php?id=new"><button>新增</button></a>
                <table class="score">
                    <thead><td>Name</td><td>View/Modify</td></thead>
                    <% scoresheet %>
                </table>
