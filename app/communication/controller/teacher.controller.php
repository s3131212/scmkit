...
class Communication_Controller {
	public function get_content($class,$date = 0){
		...
		echo Communication_View::call_view("Communication",array("data"=>$communication_data,"date"=>$date));
	}
    ...
    public function get_editor_data($empty,$class,$date){
        ...
        echo Communication_View::call_view("Communication_change",array("content"=>$content,"date"=>$date,"class_id"=>$class,"empty"=>$empty,"class"=>$model->get_class($class)));
    }
