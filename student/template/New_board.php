<html>
    ...
    $(function(){
        if(getQueryString("id")!=null){
            $("#form").attr('action','new_board.php?id='+getQueryString("id")+'&class='+getQueryString("class"));
        }else{
            $("#form").attr('action','new_board.php?id=&class='+getQueryString("class"));
        }
    });
...
<body>
    ...
    <% nav | board %>
        <section class="content">
            ...
            <form action="new_board.php?" id="form" method="post">
